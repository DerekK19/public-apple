...
@synthesize toolbar, popoverController, detailItem, subject, rootViewController;
...
- (void)configureView {
    ...
    subject.text = [[detailItem valueForKey:@"timeStamp"] description];
}
