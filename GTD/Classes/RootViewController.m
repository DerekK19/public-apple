...
- (void)viewWillAppear:(BOOL)animated {
	ThingsViewController *thingsViewController = [[ThingsViewController alloc] initWithNibName:@"ThingsViewController" bundle:nil];
	[self.navigationController pushViewController:thingsViewController animated:animated];
	[thingsViewController release];
    thingsViewController.managedObjectContext = self.managedObjectContext;
